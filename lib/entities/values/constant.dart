class AppConstants{
  static const String SERVER_API_URL = "http:///";     //Put your IP Address here for it to work. example: http://100.100.100.100:8000/      //In real life, use the domain name here and not this.
