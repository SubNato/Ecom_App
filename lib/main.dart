...
import 'package:firebase_core/firebase_core.dart';     //Remember to put the dependency classpath above the others in android gradle build.

Future<void> main() async {
  WidgetsFlutterBinding.ensureInitialized();
    //To test Firebase Connection
  await Firebase.initializeApp(               //Error appeared. The fix was to add the import of Firebase manually.
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      ...
      providers: [
        ...
        BlocProvider(
          //lazy: false, //This is (when set to false) orders this Bloc to be called first. Order ia important!
      ...
      floatingActionButton: Row(
        ...
        children: [
          FloatingActionButton(
            heroTag: "heroTag1", //Hero Tags are used to identify between the different FloatingActionButtons!
