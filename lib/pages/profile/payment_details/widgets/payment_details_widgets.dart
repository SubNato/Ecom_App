...
Widget menuView(){
  return Container(
    ...
    child: reusableText(
        "Bought and Cancelled Payments Details",
        fontSize: 14.sp,
    ),
  );
}
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Container(
                        width: 55.w,
                        child: Text(
                          state.courseItem[index].status==0?'failed':'success',      //This is saying that if the status is 0, you put 'failed', ELSE, IF it is anything other than 0, you put 'success'. It is a if then else simplified statement.
                          maxLines: 1,
                          style: TextStyle(
                              color: state.courseItem[index].status==0?Colors.red:Colors.green,
                              fontSize: 13.sp,
                              fontWeight: FontWeight.bold
                          ),
                        ),
