    ...
    try {
      ...
      if (credential.user !=
        ...
        await credential.user
            ?.sendEmailVerification(); //This line of code requests/allows the database to send a verification email to the user that registered.
        await credential.user?.updateDisplayName(
            userName); //This line of code updates or gives the user the username they requested. Most likely updated/attached to the email which tells exactly the individual.
        toastInfo(
            msg: "An email has been sent to the email ypu have registered. To acticate your account please check your email and click on the link provided.");
